...
#torchrun --standalone --nproc_per_node=4 pipeline.py --model_type Qwen --config_path config_123M --use_compile
#torchrun --standalone --nproc_per_node=4 pipeline.py --model_type Qwen --config_path config_140M --use_compile
